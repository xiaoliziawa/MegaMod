        ...
        private void InitConfig()
        {
            ...
            ReserveAlarmChanger = Config.Bind("1- All Mods", "ReserveAlarmChanger - On/Off", false,
                new ConfigDescription(
                    "Enable Reserve Alarm Changer - changes alarm sound to file on plugin folder (ONLY RUNS ON RAID START)",
                    tags: new ConfigurationManagerAttributes() { Order = 11 }));
            BushWhacker = Config.Bind("1- All Mods", "BushWhacker - On/Off", false,
                new ConfigDescription("Enable BushWhacker - removes slowdown from bushes",
                    tags: new ConfigurationManagerAttributes() { Order = 10 }));
            GrassCutter = Config.Bind("1- All Mods", "GrassCutter - On/Off", false,
                new ConfigDescription("Enable GrassCutter - removes grass",
                    tags: new ConfigurationManagerAttributes() { Order = 9 }));
            MasterKey = Config.Bind("1- All Mods", "MasterKey - On/Off", false,
                new ConfigDescription("Enable MasterKey - Changes Doors to use MasterKeyToUse",
            ...
            SpaceUser = Config.Bind("1- All Mods", "SpaceUser - On/Off", false,
                new ConfigDescription("Enable SpaceUser - Able to use spacebar to accept flea and split stacks",
                    tags: new ConfigurationManagerAttributes() { Order = 6 }));
            TradingPlayerView = Config.Bind("1- All Mods", "TradingPlayerView - On/Off", false,
                new ConfigDescription("Enable TradingPlayerView - Changes trading player view",
                    tags: new ConfigurationManagerAttributes() { Order = 5 }));
            PainkillerDesat = Config.Bind("1- All Mods", "PainkillerDesat - On/Off", false,
                new ConfigDescription("Enable PainkillerDesat - Removes effects from taking painkillers",
            ...
            MasterKeyToUse = Config.Bind("3- MasterKey", "MasterKeyToUse", EMasterKeys.Yellow,
                new ConfigDescription("This will be set to all unlockable doors",
                    tags: new ConfigurationManagerAttributes() { Order = 1 }));

            // Debugging Mods
            InstantSearch = Config.Bind("2- Debug Mods", "InstantSearch - On/Off", false,
                new ConfigDescription("Enable InstantSearch - Enables InstantSearch",
                    tags: new ConfigurationManagerAttributes() { Order = 10 }));
            FoodWater = Config.Bind("2- Debug Mods", "FoodWater - On/Off", false,
                new ConfigDescription("Enable FoodWater - removes hydration and energy drain",
                    tags: new ConfigurationManagerAttributes() { Order = 9 }));
            LootLoss = Config.Bind("2- Debug Mods", "LootLoss - On/Off", false,
                new ConfigDescription("Enable LootLoss - removes loot on map load",
                    tags: new ConfigurationManagerAttributes() { Order = 8 }));
            InventoryViewer = Config.Bind("2- Debug Mods", "InventoryViewer - On/Off", false,
                new ConfigDescription("Enable InventoryViewer - Changes inventory view to show all containers or not",
                    tags: new ConfigurationManagerAttributes() { Order = 6 }));
            GodMode = Config.Bind("2- Debug Mods", "GodMode - On/Off", false,
                new ConfigDescription("Enable GodMode - Unable to be killed",
                    tags: new ConfigurationManagerAttributes() { Order = 5 }));
            CameraShake = Config.Bind("2- Debug Mods", "CameraShake - On/Off", false,
                new ConfigDescription("Disable CameraShake - Removes CameraShake",
                    tags: new ConfigurationManagerAttributes() { Order = 4 }));
            ThermalMode = Config.Bind("2- Debug Mods", "ThermalMode - On/Off", false,
                new ConfigDescription("Enable ThermalMode - Enables ThermalMode",
                    tags: new ConfigurationManagerAttributes() { Order = 3 }));
            BetterThermalMode = Config.Bind("2- Debug Mods", "BetterThermalMode - On/Off", false,
                new ConfigDescription("Enable BetterThermalMode - Disables Blur/Noise/etc of the thermal",
                    tags: new ConfigurationManagerAttributes() { Order = 2 }));
            NightVisionMode = Config.Bind("2- Debug Mods", "NightVisionMode - On/Off", false,
                new ConfigDescription("Enable NightVisionMode - Enables NightVisionMode",
                    tags: new ConfigurationManagerAttributes() { Order = 1 }));
        }
        ...
        public static void LogToScreen(string message = "", EMessageType eMessageType = EMessageType.Info)
        {
            switch (eMessageType)
            {
                case EMessageType.NotiError:
                    ...
                    NotificationManagerClass.DisplayMessageNotification("[CWX-MegaMod Error] " + message,
                ...
                case EMessageType.NotiWarn:
                    ...
                    NotificationManagerClass.DisplayMessageNotification("[CWX-MegaMod Warning] " + message,
                ...
                case EMessageType.NotiInfo:
                    ...
                    NotificationManagerClass.DisplayMessageNotification("[CWX-MegaMod Info] " + message,
